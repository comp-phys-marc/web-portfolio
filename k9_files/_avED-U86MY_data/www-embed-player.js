...
b=Og("//web.archive.org/web/20210802045213/http://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof df&&b.abort();
return af(c)})}
...
function Im(){var a=window.location.protocol,b=W.getEntriesByType("resource");b=Xa(b,function(c){return 0===c.name.indexOf(a+"//web.archive.org/web/20210802045213/http://fonts.gstatic.com/s/")});
...
try{Vm("//web.archive.org/web/20210802045213/http://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}bn.push(jg(function(){if(!(cn||"google_ad_status"in window)){try{an("//web.archive.org/web/20210802045213/http://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}cn=!0;N("DCLKSTAT",3)}},5E3))}}
...
F("PL_ATT")&&kn.dispose();for(var a=0,b=bn.length;a<b;a++)lg(bn[a]);bn.length=0;$m("//web.archive.org/web/20210802045213/http://static.doubleclick.net/instream/ad_status.js");cn=!1;N("DCLKSTAT",0);Wd(oo,no);mo&&(mo.removeEventListener("onVideoDataChange",po),mo.destroy())});
...
/*
     FILE ARCHIVED ON 04:52:13 Aug 02, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:28:35 Oct 10, 2023.
...
/*
playback timings (ms):
  captures_list: 173.908
  exclusion.robots: 0.127
  exclusion.robots.policy: 0.117
  cdx.remote: 0.074
  esindex: 0.01
  LoadShardBlock: 72.805 (3)
  PetaboxLoader3.datanode: 77.403 (4)
  load_resource: 57.299
  PetaboxLoader3.resolve: 42.834
*/